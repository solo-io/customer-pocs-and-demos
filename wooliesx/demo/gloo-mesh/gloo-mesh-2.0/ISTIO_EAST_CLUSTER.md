...
```
kubectl --context ${EAST_CONTEXT} create namespace istio-system 
kubectl --context ${EAST_CONTEXT} create namespace istio-ingress
kubectl --context ${EAST_CONTEXT} create namespace istio-eastwest
kubectl --context ${EAST_CONTEXT} create namespace istio-config

istioctl --context ${EAST_CONTEXT} operator init --watchedNamespaces=istio-system,istio-ingress,istio-eastwest

CLUSTER_NAME=$EAST_MESH_NAME

cat <<EOF | istioctl --context ${EAST_CONTEXT} install -y -f -
